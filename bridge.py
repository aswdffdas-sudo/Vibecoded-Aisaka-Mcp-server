...
def _roblox_studio_app_running():
    ...
    try:
        ...
        return None
    return ("RobloxStudioBeta.exe" in out) or ("AisakaStudio.exe" in out) or ("RobloxStudio.exe" in out)
...
def _read_config():
    ...
    return {"mcpServers": {PRIMARY_SERVER_ID: {"command": "node", "args": ["server.js"]}}}
